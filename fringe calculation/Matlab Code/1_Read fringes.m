...
name0='F:\CCDGrab\Interferomtry data\20130605';           
name1='1';                                  
name2='2';                                      
name3='0';                                   
name4='RG';                                          
E0=imread([name0 '\' name1 '\' name2 '\' name3 '\' name4 '0.mim'],1);
E1=imread([name0 '\' name1 '\' name2 '\' name3 '\' name4 '1.mim'],1);
E2=imread([name0 '\' name1 '\' name2 '\' name3 '\' name4 '2.mim'],1);
E3=imread([name0 '\' name1 '\' name2 '\' name3 '\' name4 '3.mim'],1);
E4=imread([name0 '\' name1 '\' name2 '\' name3 '\' name4 '4.mim'],1);
